...
APP_ID = int(os.environ.get("APP_ID", "27064328"))
#Your API Hash from my.telegram.org
API_HASH = os.environ.get("API_HASH", "7be1392c2fe5ebf4fc3228706fbfb504")
#Your db channel Id
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002221575725"))
# NAMA OWNER
OWNER = os.environ.get("OWNER", "Tony Stark")
#OWNER ID
...
FORCE_SUB_CHANNEL1 = int(os.environ.get("FORCE_SUB_CHANNEL1", "-1002393151039"))
#put 0 to disable
...
SHORTLINK_API = os.environ.get("SHORTLINK_API", "eb3cef5d19adf740e108c4efcd87fdde97e331f4")
VERIFY_EXPIRE = int(os.environ.get('VERIFY_EXPIRE', 21600)) # Add time in seconds
IS_VERIFY = os.environ.get("IS_VERIFY", "True")
TUT_VID = os.environ.get("TUT_VID","https://t.me/+I7ckBD9uI8pmMjc1")


HELP_TXT = "<b><blockquote>ᴛʜɪs ɪs ᴀɴ ғɪʟᴇ ᴛᴏ ʟɪɴᴋ ʙᴏᴛ ᴡᴏʀᴋ ғᴏʀ @DigitalGalaxyHQ\n\n❏ ʙᴏᴛ ᴄᴏᴍᴍᴀɴᴅs\n├/start : sᴛᴀʀᴛ ᴛʜᴇ ʙᴏᴛ\n├/about : ᴏᴜʀ Iɴғᴏʀᴍᴀᴛɪᴏɴ\n└/help : ʜᴇʟᴘ ʀᴇʟᴀᴛᴇᴅ ʙᴏᴛ\n\n sɪᴍᴘʟʏ ᴄʟɪᴄᴋ ᴏɴ ʟɪɴᴋ ᴀɴᴅ sᴛᴀʀᴛ ᴛʜᴇ ʙᴏᴛ ᴊᴏɪɴ ʙᴏᴛʜ ᴄʜᴀɴɴᴇʟs ᴀɴᴅ ᴛʀʏ ᴀɢᴀɪɴ ᴛʜᴀᴛs ɪᴛ.....!\n\n ᴅᴇᴠᴇʟᴏᴘᴇᴅ ʙʏ <a href=https://t.me/DigitalGalaxyHQ>DɪɢɪᴛᴀʟGᴀʟᴀxʏHQ</a></blockquote></b>"


ABOUT_TXT = "<b><blockquote>◈ ᴄʀᴇᴀᴛᴏʀ: <a href=https://t.me/Tony_Stark_75>Ƭᴏɴʏ Ꮪᴛᴀʀᴋ ⎊</a>\n◈ ꜰᴏᴜɴᴅᴇʀ ᴏꜰ : <a href=https://t.me/DigitalGalaxyHQ>DɪɢɪᴛᴀʟGᴀʟᴀxʏHQ</a></blockquote></b>"
